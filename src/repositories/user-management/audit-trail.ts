import {BaseLocalRepository, AccountAppFileMappingRepository, ServiceProviderAccountRepository} from '../../repositories';
import {BelongsToAccessor, Getter, HasManyRepositoryFactory, juggler, repository} from '@loopback/repository';
import {AuditTrail, AuditLogRelations, AccountAppFileMapping, ServiceProviderAccount} from '../../models';
