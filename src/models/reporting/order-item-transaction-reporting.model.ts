...
export class OrderItemsTransactionReporting extends BaseESModel {
  @property({
    type: 'number',
    es: {type: 'long'}
  })
  ...
  // Will refer to orderItemUniqueId
  @property({
    type: 'string',
    es: {type: 'text', fields: {keyword: {type: 'keyword', ignore_above: 256}}}
  })
...
export type OrderItemsTransactionReportingWithRelations = OrderItemsTransactionReporting & OrderItemsTransactionReportingRelations;
